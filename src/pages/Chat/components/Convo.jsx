...
import { formatDateToTimeForChatMessages as fCM } from "../../../utils/formatTime";
  ...
  return dates.map((date, dateIndex) => {
    ...
    return (
      <div key={dateIndex}>
        ...
        {dateIndex === 0 && showEncryptionMessage && (
                  ...
                  <p className="chat__msg chat__msg--sent" ref={assignRef()}>
                    ...
                    <span className="chat__msg-footer">
                      ...
                      <Icon
                        ...
                        aria-label={
                          message.status === "double" ? null : message.status
                        }
                        className={`chat__msg-status-icon ${
                          message?.status === "read"
                            ? "chat__msg-status-icon--blue"

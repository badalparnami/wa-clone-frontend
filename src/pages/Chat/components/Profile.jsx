...
const Profile = ({ user, isOnline, isTyping }) => {
  return (
    <div className="profile">
      <div className="profile__section profile__section--personal">
        ...
        <p
          style={{ alignSelf: "self-end", marginTop: "7px" }}
          className={`chat__contact-desc ${isTyping ? "typing-color" : ""}`}
        >
          {isTyping
            ? "typing ..."
            : isOnline === true
      ...
      <div className="profile__section profile__section--about">
        ...
        <ul>
          <li className="profile__about-item">{user.about}</li>
